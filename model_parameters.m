...
% please help me with the voltage and current :)
Vs               = 360;               % Max. RMS phase voltage           % verify!!!!!!!
Vph              = Vs*sqrt(2);        % Peak value of phase voltage [V]                          

% Limiting the max. transient current in the output of speed loop PI
I_rated          = 18;                % Peak rated power                 % verify!!!!!!!
Iphmax           = I_rated*sqrt(2)*3;

% Mechanical system
Kt               = 1.01;              % Torque constant [Nm/A]           % verify!!!!!!! What is it used for?
...
Trat             = 10;                % Rated torque [Nm] %used to be 14
...
% SMO velocity estimation from 2. order filter 
SMO_Zeta = 1;
SMO_Omega_n = 500;

% SMO velocity estimation from 1. order filter 
SMO_tau = 1/500;
